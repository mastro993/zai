...
DROP INDEX budget_period_results_budget_period_index;
...
CREATE TABLE budgets_without_cadences (
...
SELECT budget_id, period_start, period_end, category_ids, base_allowance,
...
SELECT budget_id, period_start, period_end, net_budget_spending,
