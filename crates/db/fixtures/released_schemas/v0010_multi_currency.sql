...
DROP TABLE IF EXISTS "application_format";
...
DROP TABLE IF EXISTS "enabled_currencies";
...
CREATE TABLE recurring_template_revisions (
    ...
    transaction_category_id TEXT REFERENCES transaction_categories (id)
        ON DELETE SET NULL,
    notes TEXT, currency TEXT NOT NULL DEFAULT 'EUR'
...
DROP TABLE IF EXISTS "transaction_exchange_rate_revisions";
...
INSERT INTO __diesel_schema_migrations (version) VALUES ('202608181200000010');
COMMIT;
