    ...
    while remaining > 0 {
        ...
        for index in 0..batch {
            ...
            values.push_str(&format!(
                "('{id}', 'Perf transaction {offset}', 100, 'EUR', '2026-01-15T12:00:00', 'expense', NULL, NULL, '2026-01-01T00:00:00', '2026-01-01T00:00:00', NULL)"
            ));
            offset += 1;
        }
        let statement = format!(
            "INSERT INTO transactions (id, description, amount, currency, transaction_date, transaction_type, transaction_category_id, notes, created_at, updated_at, deleted_at) VALUES {values}"
        );
