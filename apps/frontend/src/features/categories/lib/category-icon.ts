...
export const CATEGORY_ICON_CATALOG = [
  ...
  { key: "mealvoucher", label: "Meal voucher", group: "Food", icon: VoucherIcon },
  ...
  { key: "ai", label: "AI", group: "Lifestyle", icon: SparklesIcon },
  ...
  { key: "gas", label: "Gas", group: "Home", icon: FlameIcon },
  ...
  { key: "tolls", label: "Tolls", group: "Travel", icon: RoadIcon },
  ...
  { key: "leisure", label: "Leisure", group: "Leisure", icon: KiteIcon },
  { key: "events", label: "Events", group: "Leisure", icon: FireworksIcon },
  { key: "attractions", label: "Attractions", group: "Leisure", icon: FerrisWheelIcon },
  { key: "gambling", label: "Gambling", group: "Leisure", icon: Cards01Icon },
  ...
  { key: "interest", label: "Interest", group: "Finance", icon: Coins01Icon },
