...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::recurring_transactions::rename_recurring_transaction,
            commands::recurring_transactions::edit_recurring_schedule,
            commands::recurring_transactions::edit_recurring_template,
            commands::recurring_transactions::edit_recurring_count,
