...
export const NewTransactionCategorySchema = TransactionCategorySchema.omit({
  id: true,
});
...
export const UpdatedTransactionCategorySchema =
  TransactionCategorySchema.partial().extend({
    id: z.string().uuid(),
  });

export type UpdatedTransactionCategory = z.infer<
  typeof UpdatedTransactionCategorySchema
>;
