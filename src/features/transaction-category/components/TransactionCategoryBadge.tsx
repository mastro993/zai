...
const colorVariants: Record<TransactionCategoryColor, ColorVariant> = {
  ...
  orange: {
    bg: "bg-orange-200 dark:bg-orange-600/20",
    text: "text-orange-700 dark:text-orange-500",
  },
  amber: {
    bg: "bg-amber-200 dark:bg-amber-600/20",
  ...
  lime: {
    bg: "bg-lime-200 dark:bg-lime-600/20",
  ...
  emerald: {
    bg: "bg-emerald-200 dark:bg-emerald-600/20",
    text: "text-emerald-700 dark:text-emerald-500",
  },
  teal: {
    bg: "bg-teal-200 dark:bg-teal-600/20",
    text: "text-teal-700 dark:text-teal-500",
  },
  cyan: {
    bg: "bg-cyan-200 dark:bg-cyan-600/20",
    text: "text-cyan-700 dark:text-cyan-500",
  },
  sky: {
    bg: "bg-sky-200 dark:bg-sky-600/20",
  ...
  indigo: {
    bg: "bg-indigo-200 dark:bg-indigo-600/20",
    text: "text-indigo-700 dark:text-indigo-500",
  },
  violet: {
    bg: "bg-violet-200 dark:bg-violet-600/20",
  ...
  fuchsia: {
    bg: "bg-fuchsia-200 dark:bg-fuchsia-600/20",
    text: "text-fuchsia-700 dark:text-fuchsia-500",
  },
  pink: {
    bg: "bg-pink-200 dark:bg-pink-600/20",
    text: "text-pink-700 dark:text-pink-500",
  },
  rose: {
    bg: "bg-rose-200 dark:bg-rose-600/20",
