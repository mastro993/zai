...
const buttonVariants = cva<TransactionCategoryBadgeVariants>("", {
  variants: {
    color: {
      ...
      "orange-soft":
        "bg-orange-200 border-orange-300 ring-orange-300 text-orange-800",
      "yellow-soft":
        "bg-yellow-200 border-yellow-300 ring-yellow-300 text-yellow-600",
      "green-soft":
        "bg-green-200 border-green-300 ring-green-300 text-green-600",
      ...
      "indigo-soft":
        "bg-indigo-200 border-indigo-300 ring-indigo-300 text-indigo-600",
      "purple-soft":
        "bg-purple-200 border-purple-300 ring-purple-300 text-purple-600",
      "pink-soft": "bg-pink-200 border-pink-300 ring-pink-300 text-pink-600",
      "neutral-soft":
        "bg-neutral-200 border-neutral-300 ring-neutral-300 text-neutral-600",
    },
  },
  defaultVariants: {
    color: "neutral-soft",
