...
///
/// This function sets up an r2d2 connection pool with optimized settings for SQLite:
...
///
/// This function obtains a connection from the pool, which will be automatically
